...
$data['fields']= $this->db->field_data('product'.$count.'');
 ...
 $query = $this->db->get('product');
        ...
        if($this->session->userdata('isUserLoggedIn')){
            $data['user'] = $this->user->getRows(array('id'=>$this->session->userdata('userId')));} else{
    ...
    public function file_view(){
        $this->load->view('admin/admin side/production/addproduct' ,array('error'=>''));
    }
...
$data=array('upload_data'=> $this->upload->data());
  ...
  $data['product'] = $this->vendor_model->get_item();
    ...
    $this->load->view('admin/admin side/production/error',$error);
        ...
        $error = array('error' =>'this product allready exist, please use another product or product id ');
          $data['product'] = $this->vendor_model->get_item();
$this->load->view('admin/admin side/production/addproduct',$data); 
$this->load->view('admin/admin side/production/error',$error);
}
  ...
  $config = array('upload_path'=>"./logos/",
'allowed_types'=>"gif|jpg|png|jpeg|pdf",
'overwrite'=> TRUE,
'max_size'=>"2048000",
'remove_spaces' => true
